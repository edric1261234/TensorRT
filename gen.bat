...
mkdir build
cd build
set dir=D:/Backup//TensorRT-6.0.1.5.Windows10.x86_64.cuda-10.0.cudnn7.6//TensorRT-6.0.1.5//lib//
cmake -Dnvinfer_LIB_PATH=%dir%nvinfer.lib -D nvparsers_LIB_PATH=%dir%nvparsers.lib -Dnvonnxparser_LIB_PATH=%dir%nvonnxparser.lib -DBUILD_PARSERS=OFF -DBUILD_SAMPLES=OFF -G "Visual Studio 14 2015 Win64" -DCUDA_NVCC_FLAGS='nvcc;--std;c++11' ..


msbuild TensorRT.sln /p:Configuration=Release /t:Build
